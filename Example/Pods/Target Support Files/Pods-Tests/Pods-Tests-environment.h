...
// ARNDeferred
#define COCOAPODS_POD_AVAILABLE_ARNDeferred
#define COCOAPODS_VERSION_MAJOR_ARNDeferred 0
#define COCOAPODS_VERSION_MINOR_ARNDeferred 1
#define COCOAPODS_VERSION_PATCH_ARNDeferred 0
